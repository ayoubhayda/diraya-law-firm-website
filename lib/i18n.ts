...
export const translations = {
  en: {
    ...
    aboutDescription:
      "With years of experience in legal practice, I provide trusted guidance and representation.",
  ...
  ar: {
    ...
    aboutDescription:
      "بسنوات من الخبرة في الممارسة القانونية، أقدم إرشادات موثوقة وتمثيل قانوني.",
