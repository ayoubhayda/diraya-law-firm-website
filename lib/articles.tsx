...
export const articles: Article[] = [
  {
    id: 1,
    slug: "family-law-guide-morocco",
    titleAr: "دليل شامل لقانون الأسرة في المغرب",
    titleEn: "Complete Guide to Family Law in Morocco",
    excerptAr:
    ...
    authorAr: "المحامي محمد صادق",
    authorEn: "Lawyer Mohammed Sadek",
    image: blog_1.src,
    content: {
      ar: `
        <style>
  ...
  {
    id: 2,
    slug: "company-establishment-morocco",
    titleAr: "كيفية تأسيس شركة في المغرب",
    titleEn: "How to Establish a Company in Morocco",
    excerptAr:
  ...
  {
    id: 3,
    slug: "tenant-landlord-rights-moroccan-law",
    titleAr: "حقوق المستأجر والمؤجر في القانون المغربي",
    titleEn: "Tenant and Landlord Rights in Moroccan Law",
    excerptAr:
  ...
  {
    id: 4,
    slug: "criminal-defense-strategies-morocco",
    titleAr: "استراتيجيات الدفاع الجنائي في المغرب",
    titleEn: "Criminal Defense Strategies in Morocco",
    excerptAr:
  ...
  {
    id: 5,
    slug: "contract-drafting-essentials-morocco",
    titleAr: "أساسيات صياغة العقود في المغرب",
    titleEn: "Contract Drafting Essentials in Morocco",
    excerptAr:
  ...
  {
    id: 6,
    slug: "litigation-arbitration-morocco",
    titleAr: "التقاضي والتحكيم في المغرب",
    titleEn: "Litigation and Arbitration in Morocco",
    excerptAr:
...
export function getRelatedArticles(
  ...
  return articles
    .filter(
      (article) =>
        article.slug !== currentSlug && article.category === category,
    )
    .slice(0, limit);
}
