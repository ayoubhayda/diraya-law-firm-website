      ...
      content:
        locale === "ar"
          ? [
              ...
              "• أي نزاع ينشأ يحال إلى المحاكم المختصة في الرباط",
              ...
              "• تطبق الأنظمة واللوائح المغربية على جميع الخدمات",
            ]
          : [
              "Law and dispute resolution provisions:",
              "• These terms are subject to the laws of the Kingdom of Morocco",
              "• Any arising dispute is referred to the competent courts in Rabat",
              ...
              "• Moroccan regulations and laws apply to all services",
            ],
    },
  ];
                ...
                <CardContent className="p-8">
                  ...
                  >
                    <motion.p variants={fadeInUp}>
                      ...
                      contact@diraya-law.ma
                    </motion.p>
                    <motion.p variants={fadeInUp}>
                      <strong>
                        {locale === "ar" ? "الهاتف: " : "Phone: "}
                      </strong>
                      <span dir="ltr">+212 537-123456</span>
                    </motion.p>
                    <motion.p variants={fadeInUp}>
                      <strong>
                      ...
                      {locale === "ar"
                        ? "شارع محمد الخامس، حي أكدال، الرباط، المملكة المغربية"
                        : "Mohammed V Avenue, Agdal District, Rabat, Morocco"}
                    </motion.p>
                  </motion.div>
                </CardContent>
              </Card>
